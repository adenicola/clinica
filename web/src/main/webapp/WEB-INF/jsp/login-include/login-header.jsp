...
<head>
	...
	<link rel="icon" type="image/png" href="${pageContext.request.contextPath}/images/clinexia-favicon.png">

	<link rel="stylesheet" href="${pageContext.request.contextPath}/includes/styles.css" type="text/css" />
	<link rel="stylesheet" href="${pageContext.request.contextPath}/includes/modern-theme.css" type="text/css" />
            ...
            <table class="header">
                <tr>
                    <td class="header_td">
                        ...
                        <!-- Logo -->
                        <div class="logo clinexia-brand" aria-label="Clinexia">
