            ...
            <div class="clinexia-schedule-cell">
                    ...
                    <div class="clinexia-schedule-actions">
                        <c:choose>
                            <c:when test="${event.id > 0}">
                                <a class="clinexia-inline-action clinexia-inline-action-main clinexia-inline-action-primary" href="EnterDataForStudyEvent?eventId=<c:out value='${event.id}'/>">Open Form</a>
                                <div class="clinexia-schedule-secondary-actions">
                                    ...
                                    <c:if test="${(userRole.director || userBean.sysAdmin) && study.status.available && event.editable}">
                                        <a class="clinexia-inline-action" href="UpdateStudyEvent?event_id=<c:out value='${event.id}'/>&ss_id=<c:out value='${currRow.bean.studySubject.id}'/>">Edit</a>
                                    </c:if>
                ...
                <c:forEach var="repeatEvent" items="${event.repeatEvents}" varStatus="repeatStatus">
                    <div class="clinexia-schedule-visit clinexia-schedule-visit-repeat">
                        ...
                        <div class="clinexia-schedule-actions">
                            <a class="clinexia-inline-action clinexia-inline-action-main clinexia-inline-action-primary" href="EnterDataForStudyEvent?eventId=<c:out value='${repeatEvent.id}'/>">Open Form</a>
                            <div class="clinexia-schedule-secondary-actions">
                                ...
                                <c:if test="${(userRole.director || userBean.sysAdmin) && study.status.available && repeatEvent.editable}">
                                    <a class="clinexia-inline-action" href="UpdateStudyEvent?event_id=<c:out value='${repeatEvent.id}'/>&ss_id=<c:out value='${currRow.bean.studySubject.id}'/>">Edit</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
