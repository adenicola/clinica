...
<head>
    ...
    <title><decorator:title default="Clinexia" /></title>
    <link rel="icon" type="image/png" href="../images/clinexia-favicon.png">
    ...
    <link rel="stylesheet" href="../includes/modern-theme.css" type="text/css">
    <decorator:head />
</head>
<body>
<div id="headerDiv">
